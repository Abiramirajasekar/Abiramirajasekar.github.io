...
import img1 from "./Zoom1.jpg";
import img2 from "./Zoom2.jpg";
import img3 from "./Zoom3.jpg";
import img4 from "./Zoom4.jpg";
  ...
  return (
    <div className={style.project1body}>
      ...
      <div className={style.procontentdiv}>
        ...
        <p>
          Car rental - Zoomcar Self Drive Cars ✓
          Choose from a range of cars ✓ Enjoy your Shopping, Travel,
          Daily commute, and Outstation travel ✓ Book Now!
        </p>

        <h3 style={{ color: "#B37D4E" }}>Tech stack:</h3>
        <p>React | CSS | JavaScript | EJS | Node JS</p>
        ...
        <div className={style.btndivv}>
          ...
          >
            <a
              ...
              style={{ textDecoration: "none", color: "white" }}
              target="_blank"
              href="https://relaxed-axolotl-1b3408.netlify.app/index.html"
            >
              <span>
                <svg
                  style={{
          ...
          <button className={style.btnpro} style={{ backgroundColor: "red" }}>
            <a
              ...
              style={{ textDecoration: "none", color: "white" }}
              target="_blank"
              href="https://drive.google.com/file/d/1Wm5AfnuyktYHNtgdUssfK9BolngX37ss/view?usp=sharing"
            >
              <span>
                <img
                  src={youtube}
