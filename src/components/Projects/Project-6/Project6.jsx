...
import img1 from "./N.jpg";
import img2 from "./N1.jpg";
import img3 from "./N2.jpg";
import img4 from "./N3.jpg";
import img5 from "./N4.jpg";
import img6 from "./N5.jpg";
import img7 from "./N6.jpg";
import img8 from "./N7.jpg";
import img9 from "./N8.jpg";
  ...
  return (
    <div className={style.project1body}>
      ...
      <div className={style.procontentdiv}>
        ...
        <p>
          REACT | REDUX | CHAKRA-UI | MONGOOSE | MONGODB | MONGO ATLAS
        </p>
        ...
        <div className={style.btndivv}>
          ...
          <button className={style.btnpro} style={{ backgroundColor: "red" }}>
            <a
              ...
              style={{ textDecoration: "none", color: "white" }}
              target="_blank"
              href="https://drive.google.com/file/d/1WK0idzPuzU6O-dWQY-bEfLx-BO5E4-Kj/view"
            >
              <span>
                <img
                  src={youtube}
