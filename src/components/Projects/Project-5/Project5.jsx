...
import img1 from "./HB.jpg";
import img2 from "./HB2.jpg";
import img3 from "./HB3.jpg";
import img4 from "./HB4.jpg";
import img5 from "./HB5.jpg";
import img6 from "./HB6.jpg";
import img7 from "./HB7.jpg";
import img8 from "./HB8.jpg";
  ...
  return (
    <div className={style.project1body}>
      ...
      <div className={style.procontentdiv}>
        ...
        <p>
          REACT | REDUX | CHAKRA-UI | MONGOOSE | MONGODB | MONGO ATLAS</p>
        ...
        <div className={style.btndivv}>
          ...
          <button className={style.btnpro} style={{ backgroundColor: "red" }}>
            <a
              ...
              style={{ textDecoration: "none", color: "white" }}
              target="_blank"
              href="https://drive.google.com/file/d/1rKH4O6v5Zv3ItV8yT9PFLZt1DsCBUUF8/view"
            >
              <span>
                <img
                  src={youtube}
