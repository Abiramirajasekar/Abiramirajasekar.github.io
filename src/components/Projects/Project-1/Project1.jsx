...
import img1 from "./Mama1.png";
import img2 from "./Mama2.png";
import img3 from "./Mama3.png";
import img4 from "./Mama4.png";
  ...
  return (
    <div className={style.project1body}>
      ...
      <div className={style.procontentdiv}>
        ...
        <p>
          Mamaearth is one of the most trustworthy brands in India. It offers the best-in-class skincare products to help you discover the essence of beauty with the glow
          .You can filter the products by  costs, Price Range
        ...
        <div className={style.btndivv}>
          ...
          <button className={style.btnpro} style={{ backgroundColor: "red" }}>
            <a
              ...
              style={{ textDecoration: "none", color: "white" }}
              target="_blank"
              href="https://drive.google.com/file/d/1dX_zMwk0LS0MCgEq2QCY9pSK5reR7hIH/view?usp=sharing"
            >
              <span>
                <img
                  src={youtube}
