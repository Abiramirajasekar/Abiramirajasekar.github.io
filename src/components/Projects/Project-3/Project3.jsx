...
import img1 from "./BBW1.jpg";
import img2 from "./BBW2.jpg";
import img3 from "./BBW3.jpg";
import img4 from "./BBW4.jpg";
  ...
  return (
    <div className={style.project1body}>
      ...
      <div className={style.procontentdiv}>
        ...
        >
          Bath&Body Works clone(Solo project)
        </h2>
        <p>
          This website is a clone of Bath&Body Works a skincare products website.
          Bath & Body Works is an American retail store chain that sells soaps, lotions, fragrances, and candles.
        </p>

        <h3 style={{ color: "#B37D4E" }}>Tech stack:</h3>
        <p>React | CSS | JavaScript | Node JS |Chakra-UI</p>
        ...
        <div className={style.btndivv}>
          <button className={style.btnpro} style={{ backgroundColor: "black" }}>
            <a
              ...
              target="_blank"
              href="https://github.com/Abiramirajasekar/regular-shelf-9741"
            >
              <span>
                <svg
                  style={{
